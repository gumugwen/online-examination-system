...
<body>
                                        ...
                                        <div class="layui-row layui-col-space10">
                                                ...
                                                <div class="panel layui-bg-number">
                                                    <div class="panel-body">
                                                        <div class="panel-title">
                                                            <span class="label pull-right layui-bg-blue">非实时</span>
                                                            <h5>待考试统计</h5>
                                                        </div>
                                                        <div class="panel-content">
                                                            <h1 class="no-margins">${examUnDo}</h1>
                                            ...
                                            <div class="layui-col-xs6">
                                                <div class="panel layui-bg-number">
                                                    <div class="panel-body">
                                                        <div class="panel-title">
                                                            <span class="label pull-right layui-bg-cyan">非实时</span>
                                                            <h5>已考统计</h5>
                                                        </div>
                                                        <div class="panel-content">
                                                            <h1 class="no-margins">${examDo}</h1>
                                                            <small>当前分类总记录数</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="layui-col-xs6">
                                                <div class="panel layui-bg-number">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="panel-content">
                                                            <h1 class="no-margins">${minPoint}</h1>
                                                            <small>当前分类总记录数</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="layui-col-xs6">
                                                <div class="panel layui-bg-number">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="panel-content">
                                                            <h1 class="no-margins">${maxPoint}</h1>
                                                            <small>当前分类总记录数</small>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="layui-col-md4">
                            ...
                            <table class="layui-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>演示地址</td>
                                        <td>
                                            iframe版-v2：<a href="http://layuimini.99php.cn/iframe/v2/index.html"
                                                target="_blank">点击查看</a><br>
                                            单页版-v2：<a href="http://layuimini.99php.cn/onepage/v2/index.html"
                                                target="_blank">点击查看</a><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            iframe版-v2：<a href="https://github.com/zhongshaofa/layuimini/tree/v2"
                                                ...
                                                href="https://gitee.com/zhongshaofa/layuimini/tree/v2"
                                                target="_blank">gitee</a><br>
                                            单页版-v2：<a href="https://github.com/zhongshaofa/layuimini/tree/v2-onepage"
                                                target="_blank">github</a> / <a
                                                href="https://gitee.com/zhongshaofa/layuimini/tree/v2-onepage"
                                                target="_blank">gitee</a><br>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body layui-text layadmin-text">
                            ...
                            <p>技术交流QQ群（1165301500）：<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=eUm5xKG1"><img
    ...
    <script>
        layui.use(['layer', 'miniTab', 'echarts'], function () {
            ...
            //var legend_data = [];
            var xAxis_data = [];
            var yAxis_data_point = [], yAxis_data_count = [];
            var json = {}, json_color = {}, json_normal = {}, json1 = {}, json_color1 = {}, json_normal1 = {};
            var jsons = ""; var jsontest = {}; var data_title = "";
            var json_array=[];
            $(function () {
                $.ajax({
                    type: "Get",
                    url: "${basePath}/test/getdate",
                    success: function (data) {
                        ...
                        if (data["status"] > 0) {
                            ...
                            array.forEach(element => {
                                xAxis_data.push(element.exam_title);
                                yAxis_data_point.push(element.point);
                                yAxis_data_count.push(element.count);
                            });
                            json["name"] = '分数';
                            json["data"] = yAxis_data_point;
                            json["type"] = 'bar';
                            json_color["color"] = 'red';
                            json_normal["normal"] = json_color;
                            json["itemStyle"] = json_normal;
                            json1["name"] = '总分';
                            json1["data"] = yAxis_data_count;
                            json1["type"] = 'bar';
                            json_color1["color"] = 'blue';
                            json_normal1["normal"] = json_color1;
                            json1["itemStyle"] = json_normal1;
                            json_array.push(json);
                            json_array.push(json1);
                            console.log(json);
                            console.log(json1);
                            var jsons_data = (JSON.stringify(json) + JSON.stringify(json1).replace(/{/,',{'));
                            jsontest["test"] = jsons_data;
                            console.log(jsontest["test"]);
                            // jsons = "[" + JSON.stringify(json) + "," + JSON.stringify(json1) + "]";
                            // jsons = JSON.stringify(jsons).replace(/\"/g, "");
                            // jsons = jsons.replace(/\:/g, "\:\"").replace(/\,\\/g, "\"\,").replace(/\"\[/g, "\[").replace(/\]\"/g, "\]").replace(/\"{/g, "\"").replace(/\\}/g, "\"}").replace(/\"\\normal\\\:\"/g, "{normal:{").replace(/\\/g, "");
                            // console.log(jsons);
