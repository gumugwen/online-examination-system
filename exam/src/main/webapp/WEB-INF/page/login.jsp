            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src='${basePath}/captcha/1' onclick="this.src='http://localhost:8085/captcha/1?'+Math.random()">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="role">
                            ...
                            <option selected value="2">教师</option>
...
<script>
    function changeCode() {
        document.getElementById("captchaPic").src = "${basePath}/captcha?" + Math.random();
    }
